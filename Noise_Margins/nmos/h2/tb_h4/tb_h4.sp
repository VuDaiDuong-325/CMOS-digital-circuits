*=======================================================
* TESTBENCH PMOS DIODE CONNECTED (h4.SPF) - NGUON DONG
*=======================================================
...
* Nguon dong rut dong tu ngo ra (out) xuong dat
Iload out 0 1uA
...
* --- DO DONG DIEN Ids ---
* Đo dòng cấp từ nguồn Vdd (chính là tổng dòng chảy qua cực Source/Drain của PMOS)
